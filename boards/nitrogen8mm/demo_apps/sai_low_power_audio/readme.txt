...
2.  The wm8524 codec on the Nitrogen8MMini board and the ak4497 codec on the audio board are both supported,
...
5.  If there is no audio playback, the M core will enter the STOP mode, then the whole system would enter DSM mode once A53 suspend.
    Press the ON/OFF button on the Nitrogen8MMini board, could wakeup A53 core;
