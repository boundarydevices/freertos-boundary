...
- pin_list:
  ...
  - {pin_num: AG2, peripheral: LPI2C0, signal: lpi2c_sda, pin_signal: PTA9, PS: DOWN, ODE: OPEN_DRAIN}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  - {pin_num: AG2, peripheral: GPIOA, signal: 'pta, 9', pin_signal: PTA9}
  - {pin_num: AF4, peripheral: GPIOA, signal: 'pta, 8', pin_signal: PTA8}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
