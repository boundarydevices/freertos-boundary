 ...
 *
 * END ****************************************************************************************************************/
void LPSPI1_InitPins(void) {                               /*!< Function assigned for the core: Cortex-M33[cm33] */
...
- pin_list:
  - {pin_num: AF6, peripheral: GPIOA, signal: 'pta, 18', pin_signal: PTA18}
  - {pin_num: AD8, peripheral: GPIOA, signal: 'pta, 17', pin_signal: PTA17}
  - {pin_num: AH6, peripheral: GPIOA, signal: 'pta, 16', pin_signal: PTA16}
  - {pin_num: AH4, peripheral: GPIOA, signal: 'pta, 15', pin_signal: PTA15}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
 ...
 *
 * END ****************************************************************************************************************/
void LPSPI1_DeinitPins(void) {                             /*!< Function assigned for the core: Cortex-M33[cm33] */
