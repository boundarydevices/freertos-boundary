 ...
 *
 * END ****************************************************************************************************************/
void LPUART1_InitPins(void) {                              /*!< Function assigned for the core: Cortex-M33[cm33] */
...
- pin_list:
  - {pin_num: AH2, peripheral: GPIOA, signal: 'pta, 10', pin_signal: PTA10}
  - {pin_num: AH3, peripheral: GPIOA, signal: 'pta, 11', pin_signal: PTA11}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
 ...
 *
 * END ****************************************************************************************************************/
void LPUART1_DeinitPins(void) {                            /*!< Function assigned for the core: Cortex-M33[cm33] */
    IOMUXC_SetPinMux(IOMUXC_PTA10_PTA10, 0U);
    IOMUXC_SetPinMux(IOMUXC_PTA11_PTA11, 0U);
}
