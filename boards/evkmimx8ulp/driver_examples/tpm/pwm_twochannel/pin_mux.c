...
- pin_list:
  ...
  - {pin_num: AF6, peripheral: TPM0, signal: 'tpm_ch, 3', pin_signal: PTA18, PS: UP, PE: ENABLED}
  - {pin_num: AH4, peripheral: TPM0, signal: 'tpm_ch, 0', pin_signal: PTA15, PS: UP, PE: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
