...
- pin_list:
  ...
  - {pin_num: AH4, peripheral: I3C0, signal: i3c_sda, pin_signal: PTA15, PS: DOWN, PE: DISABLED, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AJ6, peripheral: I3C0, signal: i3c_pur, pin_signal: PTA24, PS: DOWN, PE: DISABLED, SRE: STANDARD, DSE: STANDARD}
  - {pin_num: AF1, peripheral: I3C0, signal: i3c_scl, pin_signal: PTA6, PS: DOWN, PE: DISABLED, SRE: SLOW, DSE: HIDRIVE}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
