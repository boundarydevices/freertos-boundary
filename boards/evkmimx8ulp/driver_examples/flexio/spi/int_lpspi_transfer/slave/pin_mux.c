...
- pin_list:
  ...
  - {pin_num: AH6, peripheral: LPSPI1, signal: lpspi_sin, pin_signal: PTA16, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AD8, peripheral: LPSPI1, signal: lpspi_sout, pin_signal: PTA17, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AH4, peripheral: LPSPI1, signal: 'lpspi_pcs, 0', pin_signal: PTA15, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AF6, peripheral: LPSPI1, signal: lpspi_sck, pin_signal: PTA18, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AD12, peripheral: FXIO0, signal: 'fxio_d, 16', pin_signal: PTB0, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AH11, peripheral: FXIO0, signal: 'fxio_d, 17', pin_signal: PTB1, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AE12, peripheral: FXIO0, signal: 'fxio_d, 18', pin_signal: PTB2, SRE: SLOW, DSE: HIDRIVE}
  - {pin_num: AH12, peripheral: FXIO0, signal: 'fxio_d, 19', pin_signal: PTB3, SRE: SLOW, DSE: HIDRIVE}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
