...
const uint32_t defaultLUTOctalMode_GIGADEVICE[CUSTOM_LUT_LENGTH] = {
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_ERASESECTOR] = FLEXSPI_LUT_SEQ(
        ...
        kFLEXSPI_8PAD,
        SPINOR_OP_SE_21_GIGADEVICE, /* SPINOR_OP_SE_21_GIGADEVICE for GIGADEVICE, SPINOR_OP_BE_4K for ATXP032 */
        kFLEXSPI_Command_RADDR_DDR,
        kFLEXSPI_8PAD,
        SPINOR_ADDRESS_32_BITS),
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_READSTATUS_OPI + 1] = FLEXSPI_LUT_SEQ(
        kFLEXSPI_Command_READ_DDR, kFLEXSPI_8PAD, SPINOR_DATA_SIZE_1_BYTES, kFLEXSPI_Command_STOP, kFLEXSPI_1PAD, 0x0),
};
