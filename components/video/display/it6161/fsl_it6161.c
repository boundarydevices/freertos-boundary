...
static void it6161_MIPIRX_CONF(display_handle_t *handle)
{
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_SYS_CONF_REG0C,
                       ...
                       MIPI_RX_SYS_CONF_REG0C_RegEnLaneSwap(it6161.mipi_rx.mipirx_lane_swap) |
                           MIPI_RX_SYS_CONF_REG0C_RegEnPNSwap(it6161.mipi_rx.mipirx_dpdn_swap) |
                           MIPI_RX_SYS_CONF_REG0C_RegLaneNum(it6161.mipi_rx.lanes));
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_CLKBUF_CTRL_REG11,
                       ...
                       MIPI_RX_CLKBUF_CTRL_REG11_RegInvMCLK(it6161.mipi_rx.inverse_mclk) |
                           MIPI_RX_CLKBUF_CTRL_REG11_RegInvPCLK(it6161.mipi_rx.inverse_pclk) |
                           MIPI_RX_CLKBUF_CTRL_REG11_RegEnStandby(it6161.mipi_rx.enable_standby_mode) |
                           MIPI_RX_CLKBUF_CTRL_REG11_RegEnStb2Rst(it6161.mipi_rx.enable_standby_to_reset) |
                           MIPI_RX_CLKBUF_CTRL_REG11_RegEnIDDQ(it6161.mipi_rx.enable_iddq_mode));
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_CLKBUF_CTRL_REG12,
                       ...
                       MIPI_RX_CLKBUF_CTRL_REG12_RegPDREFCLK(it6161.mipi_rx.pd_ref_clk) |
                           MIPI_RX_CLKBUF_CTRL_REG12_RegPDREFCNT(it6161.mipi_rx.pd_ref_cnt));
    ...
    MIPIRX_SetI2C_Byte(
        ...
        MIPI_RX_PPI_REG18_RegHSSetNum(it6161.mipi_rx.hs_settle_num) |
            MIPI_RX_PPI_REG18_RegSkipStg(it6161.mipi_rx.hs_trailing_skip_stage) |
            MIPI_RX_PPI_REG18_RegEnSyncErr(it6161.mipi_rx.enable_sync_bit_error_tolerance));
    ...
    MIPIRX_SetI2C_Byte(
        ...
        MIPI_RX_PPI_REG19_RegEnDeSkew(it6161.mipi_rx.enable_multi_lane_deskew) |
            MIPI_RX_PPI_REG19_RegEnContCK(it6161.mipi_rx.force_continuous_clock_mode) |
            MIPI_RX_PPI_REG19_RegPPIDbgSel(it6161.mipi_rx.ppi_debug_selection));
    ...
    MIPIRX_SetI2C_Byte(
        ...
        MIPI_RX_LANE_MERGE_PACKET_DECODER_REG20_RegIgnrNull(it6161.mipi_rx.ignore_null_packet) |
            MIPI_RX_LANE_MERGE_PACKET_DECODER_REG20_RegIgnrBlk(it6161.mipi_rx.ignore_blank_packet) |
            MIPI_RX_LANE_MERGE_PACKET_DECODER_REG20_RegEnDummyECC(it6161.mipi_rx.enable_dummy_ecc_error) |
            MIPI_RX_LANE_MERGE_PACKET_DECODER_REG20_RegSelEOTP(it6161.mipi_rx.sel_eotp));
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_LANE_MERGE_PACKET_DECODER_REG21,
                       ...
                       MIPI_RX_LANE_MERGE_PACKET_DECODER_REG21_RegSelLMDbg(it6161.mipi_rx.lm_debug_selection));
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG4C,
                       ...
                       MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG4C_RegFFRdStg(
                           it6161.mipi_rx.pps_fifo_read_start_point & 0xFFU));
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG70,
                       ...
                       MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG70_RegEnMAvg(
                           it6161.mipi_rx.enable_mclk_horizontal_average));
    MIPIRX_WriteI2C_Byte(handle, MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG72,
                         MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG72_RegMShift(
                             it6161.mipi_rx.allowable_mclk_horizontal_shift_value));
    MIPIRX_WriteI2C_Byte(handle, MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG73,
                         MIPI_RX_PACKED_PIXEL_STREAM_TIMING_GENERATOR_AND_PATTERN_GENERATION_REG73_RegPShift(
                             it6161.mipi_rx.allowable_pclk_horizontal_shift_value));
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_AFE_REG80, MIPI_RX_AFE_REG80_RegEnExtPCLK_MASK,
                       MIPI_RX_AFE_REG80_RegEnExtPCLK(it6161.mipi_rx.enable_external_pclk));
    ...
    MIPIRX_SetI2C_Byte(handle, MIPI_RX_TX_PATTERN_CONTENT_REGA0, MIPI_RX_TX_PATTERN_CONTENT_REGA0_RegMBPM_MASK,
                       MIPI_RX_TX_PATTERN_CONTENT_REGA0_RegMBPM(it6161.mipi_rx.bypass_through_mode));
    ...
    if (it6161.mipi_rx.bypass_through_mode)
    {
    ...
    if (!it6161.mipi_rx.user_define_timming)
    {
        MIPIRX_SetI2C_Byte(
...
RegSetTable_t HDMITX_Init_Table[] = {
...
RegSetTable_t HDMITX_PwrOn_Table[] = {
...
status_t IT6161_Init(display_handle_t *handle, const display_config_t *config)
{
    ...
    it6161.mipi_rx.enable_v_timing_resync_enhance_mode   = 00U;
    ...
    if (it6161.hdmi_tx.support_audio)
    {
        ...
        it6161.hdmi_tx.input_audio_interface   = HDMI_TX_INPUT_AUDIO_INTERFACE;
