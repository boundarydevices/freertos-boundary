if(NOT MIDDLEWARE_MULTICORE_RPMSG_LITE_MIMX8MQ6_INCLUDED)
    
    set(MIDDLEWARE_MULTICORE_RPMSG_LITE_MIMX8MQ6_INCLUDED true CACHE BOOL "middleware_multicore_rpmsg_lite component is included.")
    ...
    elseif(CONFIG_USE_middleware_freertos-kernel_MIMX8MQ6)
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
        ...
        message(WARNING "please config middleware.baremetal_MIMX8MQ6 or middleware.freertos-kernel_MIMX8MQ6 first.")
    endif()
