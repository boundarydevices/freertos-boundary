...
#  # description: Devices_project_template MIMX8UD7
#  set(CONFIG_USE_DEVICES_Project_Template_MIMX8UD7 true)

#  # description: Device MIMX8UD7_cmsis
#  set(CONFIG_USE_device_MIMX8UD7_CMSIS true)

#  # description: Device MIMX8UD7_dsp
#  set(CONFIG_USE_device_MIMX8UD7_DSP true)
...
#  set(CONFIG_USE_driver_flexspi_dma3 true)
...
#  # description: AD EDMA Driver
#  set(CONFIG_USE_driver_ad_dma3 true)
...
#  # description: RPMsg-Lite for evkmimx8ulp_m33 FreeRTOS application
...
include_if_use(DEVICES_Project_Template_MIMX8UD7.MIMX8UD7)
include_if_use(RTE_Device.MIMX8UD7)
include_if_use(component_audio_sai_edma_adapter.MIMX8UD7)
include_if_use(component_button.MIMX8UD7)
include_if_use(component_codec_adapters.MIMX8UD7)
...
include_if_use(component_lptmr_adapter.MIMX8UD7)
...
include_if_use(component_rgpio_adapter.MIMX8UD7)
include_if_use(component_rtc_bbnsm_adapter.MIMX8UD7)
include_if_use(component_serial_manager.MIMX8UD7)
include_if_use(component_serial_manager_spi.MIMX8UD7)
include_if_use(component_serial_manager_swo.MIMX8UD7)
include_if_use(component_serial_manager_uart.MIMX8UD7)
include_if_use(component_serial_manager_virtual.MIMX8UD7)
include_if_use(component_sgtl_adapter.MIMX8UD7)
include_if_use(component_software_crc_adapter.MIMX8UD7)
...
include_if_use(device_MIMX8UD7_startup.MIMX8UD7)
include_if_use(driver_acmp.MIMX8UD7)
...
include_if_use(driver_cmsis_lpspi.MIMX8UD7)
include_if_use(driver_cmsis_lpuart.MIMX8UD7)
...
include_if_use(driver_flexio_camera.MIMX8UD7)
include_if_use(driver_flexio_camera_edma.MIMX8UD7)
include_if_use(driver_flexio_i2c_master.MIMX8UD7)
include_if_use(driver_flexio_i2s.MIMX8UD7)
include_if_use(driver_flexio_i2s_edma.MIMX8UD7)
include_if_use(driver_flexio_mculcd.MIMX8UD7)
include_if_use(driver_flexio_mculcd_edma.MIMX8UD7)
include_if_use(driver_flexio_spi.MIMX8UD7)
include_if_use(driver_flexio_spi_edma.MIMX8UD7)
include_if_use(driver_flexio_uart.MIMX8UD7)
include_if_use(driver_flexio_uart_edma.MIMX8UD7)
include_if_use(driver_flexspi.MIMX8UD7)
include_if_use(driver_flexspi_dma3.MIMX8UD7)
include_if_use(driver_fusion.MIMX8UD7)
include_if_use(driver_fxos8700cq.MIMX8UD7)
include_if_use(driver_i3c.MIMX8UD7)
include_if_use(driver_iomuxc.MIMX8UD7)
include_if_use(driver_lcdif.MIMX8UD7)
include_if_use(driver_lpadc.MIMX8UD7)
include_if_use(driver_lpi2c.MIMX8UD7)
include_if_use(driver_lpi2c_edma.MIMX8UD7)
include_if_use(driver_lpi2c_freertos.MIMX8UD7)
include_if_use(driver_lpit.MIMX8UD7)
include_if_use(driver_lpspi.MIMX8UD7)
include_if_use(driver_lpspi_edma.MIMX8UD7)
include_if_use(driver_lpspi_freertos.MIMX8UD7)
include_if_use(driver_lptmr.MIMX8UD7)
include_if_use(driver_lpuart.MIMX8UD7)
include_if_use(driver_lpuart_edma.MIMX8UD7)
include_if_use(driver_lpuart_freertos.MIMX8UD7)
include_if_use(driver_lsm6dso.MIMX8UD7)
include_if_use(driver_memory.MIMX8UD7)
include_if_use(driver_mipi_dsi.MIMX8UD7)
include_if_use(driver_mrt.MIMX8UD7)
include_if_use(driver_mu1.MIMX8UD7)
include_if_use(driver_nand_flash-common.MIMX8UD7)
include_if_use(driver_nand_flash-controller-flexspi.MIMX8UD7)
include_if_use(driver_nor_flash-common.MIMX8UD7)
include_if_use(driver_nor_flash-controller-flexspi.MIMX8UD7)
include_if_use(driver_nor_flash-controller-lpspi.MIMX8UD7)
include_if_use(driver_pca6416a.MIMX8UD7)
include_if_use(driver_pdm.MIMX8UD7)
include_if_use(driver_pdm_edma.MIMX8UD7)
include_if_use(driver_pf1550.MIMX8UD7)
include_if_use(driver_powerquad.MIMX8UD7)
include_if_use(driver_powerquad_cmsis.MIMX8UD7)
include_if_use(driver_pxp.MIMX8UD7)
include_if_use(driver_reset.MIMX8UD7)
include_if_use(driver_rgpio.MIMX8UD7)
include_if_use(driver_rtd_cmc.MIMX8UD7)
include_if_use(driver_sai.MIMX8UD7)
include_if_use(driver_sai_edma.MIMX8UD7)
include_if_use(driver_sema42.MIMX8UD7)
include_if_use(driver_sentinel.MIMX8UD7)
include_if_use(driver_sgtl5000.MIMX8UD7)
include_if_use(driver_soc_mipi_dsi.MIMX8UD7)
include_if_use(driver_srtm.MIMX8UD7)
include_if_use(driver_srtm_freertos.MIMX8UD7)
include_if_use(driver_tpm.MIMX8UD7)
include_if_use(driver_trdc.MIMX8UD7)
include_if_use(driver_trgmux.MIMX8UD7)
include_if_use(driver_tstmr.MIMX8UD7)
include_if_use(driver_upower.MIMX8UD7)
include_if_use(driver_video-common.MIMX8UD7)
include_if_use(driver_video-i2c.MIMX8UD7)
include_if_use(driver_wdog32.MIMX8UD7)
include_if_use(driver_wm8960.MIMX8UD7)
include_if_use(driver_wuu.MIMX8UD7)
include_if_use(middleware_baremetal.MIMX8UD7)
...
include_if_use(utility_assert.MIMX8UD7)
include_if_use(utility_assert_lite.MIMX8UD7)
include_if_use(utility_debug_console.MIMX8UD7)
include_if_use(utility_debug_console_lite.MIMX8UD7)
include_if_use(utility_notifier.MIMX8UD7)
include_if_use(utility_shell.MIMX8UD7)
include_if_use(utility_str.MIMX8UD7)
