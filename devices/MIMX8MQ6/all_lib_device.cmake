...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimx8mq/project_template
...
include_if_use(BOARD_Project_Template_evkmimx8mq)
...
include_if_use(DEVICES_Project_Template_MIMX8MQ6.MIMX8MQ6)
include_if_use(RTE_Device.MIMX8MQ6)
include_if_use(component_button.MIMX8MQ6)
include_if_use(component_codec_adapters.MIMX8MQ6)
include_if_use(component_codec_i2c.MIMX8MQ6)
include_if_use(component_common_task)
include_if_use(component_gpt_adapter.MIMX8MQ6)
include_if_use(component_igpio_adapter.MIMX8MQ6)
include_if_use(component_ii2c_adapter.MIMX8MQ6)
include_if_use(component_iuart_adapter.MIMX8MQ6)
include_if_use(component_led.MIMX8MQ6)
include_if_use(component_lists.MIMX8MQ6)
include_if_use(component_mem_manager.MIMX8MQ6)
include_if_use(component_mem_manager_freertos.MIMX8MQ6)
include_if_use(component_mem_manager_light.MIMX8MQ6)
...
include_if_use(component_panic.MIMX8MQ6)
include_if_use(component_reset_adapter.MIMX8MQ6)
include_if_use(component_serial_manager.MIMX8MQ6)
include_if_use(component_serial_manager_swo.MIMX8MQ6)
include_if_use(component_serial_manager_uart.MIMX8MQ6)
include_if_use(component_serial_manager_virtual.MIMX8MQ6)
include_if_use(component_software_crc_adapter.MIMX8MQ6)
include_if_use(component_software_rng_adapter.MIMX8MQ6)
include_if_use(component_timer_manager.MIMX8MQ6)
include_if_use(component_wm8524_adapter.MIMX8MQ6)
include_if_use(device_MIMX8MQ6_CMSIS.MIMX8MQ6)
include_if_use(device_MIMX8MQ6_startup.MIMX8MQ6)
include_if_use(device_MIMX8MQ6_system.MIMX8MQ6)
include_if_use(driver_cache_lmem.MIMX8MQ6)
include_if_use(driver_clock.MIMX8MQ6)
include_if_use(driver_cmsis_ecspi.MIMX8MQ6)
include_if_use(driver_cmsis_ii2c.MIMX8MQ6)
include_if_use(driver_cmsis_iuart.MIMX8MQ6)
include_if_use(driver_codec.MIMX8MQ6)
include_if_use(driver_common.MIMX8MQ6)
include_if_use(driver_ecspi.MIMX8MQ6)
include_if_use(driver_ecspi_freertos.MIMX8MQ6)
include_if_use(driver_gpt.MIMX8MQ6)
include_if_use(driver_igpio.MIMX8MQ6)
include_if_use(driver_ii2c.MIMX8MQ6)
include_if_use(driver_ii2c_freertos.MIMX8MQ6)
include_if_use(driver_iomuxc.MIMX8MQ6)
include_if_use(driver_ipwm.MIMX8MQ6)
include_if_use(driver_iuart.MIMX8MQ6)
include_if_use(driver_iuart_freertos.MIMX8MQ6)
include_if_use(driver_mu.MIMX8MQ6)
include_if_use(driver_pca6416a.MIMX8MQ6)
include_if_use(driver_qspi.MIMX8MQ6)
include_if_use(driver_rdc.MIMX8MQ6)
include_if_use(driver_rdc_sema42.MIMX8MQ6)
include_if_use(driver_sai.MIMX8MQ6)
include_if_use(driver_sema4.MIMX8MQ6)
include_if_use(driver_tmu.MIMX8MQ6)
include_if_use(driver_wdog01.MIMX8MQ6)
include_if_use(driver_wm8524.MIMX8MQ6)
include_if_use(middleware_baremetal.MIMX8MQ6)
...
include_if_use(middleware_multicore_rpmsg_lite_imx8mq_m4_bm)
include_if_use(middleware_multicore_rpmsg_lite_imx8mq_m4_freertos)
...
include_if_use(utilities_misc_utilities.MIMX8MQ6)
include_if_use(utility_assert.MIMX8MQ6)
include_if_use(utility_assert_lite.MIMX8MQ6)
include_if_use(utility_debug_console.MIMX8MQ6)
include_if_use(utility_debug_console_lite.MIMX8MQ6)
include_if_use(utility_str.MIMX8MQ6)
