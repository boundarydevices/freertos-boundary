    ...
    {                                                                                                                  \
        {kCLOCK_Osc24MClk,    kCLOCK_SysPll2Div5Clk, kCLOCK_SysPll2Div4Clk, kCLOCK_SysPll1Div3Clk, kCLOCK_SysPll1Clk,  \
         kCLOCK_AudioPll1Clk, kCLOCK_VideoPll1Clk,   kCLOCK_SysPll3Clk}, /* Cortex-M4 Clock Root. */                   \
            {kCLOCK_Osc24MClk,  kCLOCK_SysPll2Div3Clk, kCLOCK_SysPll1Clk,   kCLOCK_SysPll2Div4Clk,                     \
             kCLOCK_SysPll2Clk, kCLOCK_AudioPll1Clk,   kCLOCK_VideoPll1Clk, kCLOCK_NoneName}, /* AXI Clock Root. */    \
            ...
            {kCLOCK_Osc24MClk,      kCLOCK_AudioPll1Clk, kCLOCK_AudioPll2Clk, kCLOCK_VideoPll1Clk,                     \
             kCLOCK_SysPll1Div6Clk, kCLOCK_NoneName,     kCLOCK_ExtClk1,      kCLOCK_ExtClk2}, /* SAI4 Clock Root */   \
            {kCLOCK_Osc24MClk,      kCLOCK_AudioPll1Clk, kCLOCK_AudioPll2Clk, kCLOCK_VideoPll1Clk,                     \
...
#define CLOCK_ROOT_CONTROL_TUPLE                                                                                      \
    {                                                                                                                 \
        kCLOCK_RootM4, kCLOCK_RootAxi, kCLOCK_RootNoc, kCLOCK_RootAhb, kCLOCK_RootAhb, kCLOCK_RootAudioAhb,           \
            kCLOCK_RootAudioAhb, kCLOCK_RootDramAlt, kCLOCK_RootSai1, kCLOCK_RootSai2, kCLOCK_RootSai3,               \
            kCLOCK_RootSai4, kCLOCK_RootSai5, kCLOCK_RootSai6, kCLOCK_RootQspi, kCLOCK_RootI2c1, kCLOCK_RootI2c2,     \
            kCLOCK_RootI2c3, kCLOCK_RootI2c4, kCLOCK_RootUart1, kCLOCK_RootUart2, kCLOCK_RootUart3, kCLOCK_RootUart4, \
...
{
    kCLOCK_RootM4 =
        (uintptr_t)CCM_BASE + offsetof(CCM_Type, ROOT[1].TARGET_ROOT), /*!< ARM Cortex-M4 Clock control name.*/
    kCLOCK_RootAxi = (uintptr_t)CCM_BASE + offsetof(CCM_Type, ROOT[16].TARGET_ROOT), /*!< AXI Clock control name.*/
    kCLOCK_RootEnetAxi = (uintptr_t)CCM_BASE + offsetof(CCM_Type, ROOT[17].TARGET_ROOT), /*!< ENET AXI Clock control name.*/
    ...
    kCLOCK_RootSai4 = (uintptr_t)CCM_BASE + offsetof(CCM_Type, ROOT[78].TARGET_ROOT), /*!< SAI4 Clock control name.*/
...
{
    kCLOCK_M4RootmuxOsc24M      = 0U, /*!< ARM Cortex-M4 Clock from OSC 24M.*/
...
typedef enum _clock_pll_bypass_ctrl
{
    ...
    kCLOCK_GpuPLLPwrBypassCtrl = CCM_ANALOG_TUPLE(
        GPU_PLL_GEN_CTRL_OFFSET, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Gpu PLL bypass Control.*/

    kCLOCK_VpuPllPwrBypassCtrl = CCM_ANALOG_TUPLE(
        VPU_PLL_GEN_CTRL_OFFSET, CCM_ANALOG_VPU_PLL_GEN_CTRL_PLL_BYPASS_SHIFT), /*!< CCM Vpu PLL bypass Control.*/
...
typedef enum _ccm_analog_pll_clke
{
    ...
    kCLOCK_GpuPllClke =
        CCM_ANALOG_TUPLE(GPU_PLL_GEN_CTRL_OFFSET, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Gpu pll clke */
    kCLOCK_VpuPllClke =
        CCM_ANALOG_TUPLE(VPU_PLL_GEN_CTRL_OFFSET, CCM_ANALOG_VPU_PLL_GEN_CTRL_PLL_CLKE_SHIFT), /*!< Vpu pll clke */
    kCLOCK_ArmPllClke =
...
typedef enum _clock_pll_ctrl
{
    ...
    kCLOCK_GpuPllCtrl     = CCM_ANALOG_TUPLE(GPU_PLL_GEN_CTRL_OFFSET, CCM_ANALOG_GPU_PLL_GEN_CTRL_PLL_RST_SHIFT),
