...
uint32_t CLOCK_GetPllFreq(clock_pll_ctrl_t pll)
{
    ...
    switch (pll)
    {
        ...
        case kCLOCK_GpuPllCtrl:
            intergerPllBypass = CLOCK_IsPllBypassed(CCM_ANALOG, kCLOCK_GpuPLLPwrBypassCtrl);
            break;
        case kCLOCK_VpuPllCtrl:
            intergerPllBypass = CLOCK_IsPllBypassed(CCM_ANALOG, kCLOCK_VpuPllPwrBypassCtrl);
            break;
